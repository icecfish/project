...
<div class="container">
	...
	<div class="col-md-7 column">
					<div class="cart" >
			<div class="cart-title" style="margin-top: 5px;">订单号：${sessionScope.order.orderId}</div>
			...
			<table class="cart-table">
				...
				<tr class="cart-bottom">
					<td colspan="6">
						...
						<span class="cart-bottom-span">总计：<span class="cart-total-price">${sessionScope.order.price}</span></span>
						<a href="orderServlet?action=cancel"><span class="cart-bottom-btn">取消订单</span></a>
						<a href="alipay.trade.page.pay.jsp"><span class="cart-bottom-btn">付&emsp;款</span></a>
					</td>
				</tr>
			</table>
		</div>
