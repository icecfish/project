<%@ page import="com.igeek.service.OrderService" %>
	...
	<div class="row clearfix">
		...
		<div class="col-md-10 column">
			<table class="cart-table" style="margin-top: 20px;">
				<tr>
					<th width="150px"><span class="cart-all" style="font-size: 16px;font-weight: bolder">&nbsp;会员账号</span></th>
					<th style="font-size: 16px;width：180px;font-weight: bolder">会员昵称</th>
					<th style="font-size: 16px;font-weight: bolder">&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;手机号</th>
					<th width="250px"style="font-size: 16px;font-weight: bolder">&emsp;&emsp;邮箱</th>
					<th width="150px" style="font-size: 16px;font-weight: bolder">消费金额</th>
				</tr>

				<c:forEach items="${requestScope.users}" var="user">
					<tr class="cart-item">
						<td class="cart-txt-left"><span class="cart-name">${user.username}</span></td>
						<td class="cart-txt-left"><span class="cart-intro">${user.nickname}</span></td>
						<td><span class="cart-price">${user.phone}</span></td>
						<td class="cart-txt-left"><span class="cart-name">${user.email}</span></td>
						<td class="cart-txt-left"><span class="cart-name">${user.password}</span></td>
					</tr>
				</c:forEach>
				...
				<tr class="cart-bottom">
					<td colspan="6">
						...
						<p style="font-weight: bolder;font-size: 20px;float: right;color: #D58512">总金额:${requestScope.allPrice}&emsp;&emsp;</p>
...
<%--										location.href="http://localhost:8080/project/foodServlet?action=page&pageNo=${requestScope.page.pageTotal}";--%>
<%--									}else if(pageNo< 1){--%>
<%--										location.href="http://localhost:8080/project/foodServlet?action=page&pageNo=1";--%>
<%--									}else--%>
<%--										location.href="http://localhost:8080/project/foodServlet?action=page&pageNo="+pageNo;--%>
<%--								})--%>
<%--							})--%>
<%--						</script>--%>
<%--					</div>--%>
